...
// KERNEL COSINE
// ============================================================================
__global__ void cosine_strategy1(
    ...
    int dim)
{
    ...
    // Sequential loop over dimensions
    float dot = 0.0f;
    float normA = 0.0f;
    float normB = 0.0f;
...
int main(int argc, char* argv[]) {
    ...
    try {
        ...
        std::cout << "\n=== Strategy 1: Grid over pairs, Cosine Benchmark ===" << std::endl;
        ...
        launch_cosine_strategy1(d_queries, d_database, d_results, num_queries, num_database, dim);
