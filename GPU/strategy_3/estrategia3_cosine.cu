...
// KERNEL COSINE
// ============================================================================
__global__ void cosine_strategy3(
...
int main(int argc, char* argv[]) {
    ...
    try {
        ...
        std::cout << "\n=== Strategy 3: Grid over BIG group, Cosine Benchmark ===" << std::endl;
        ...
        launch_cosine_strategy3(d_queries, d_database, d_results, num_queries, num_database, dim, block_size);
