#!/bin/bash
# ============================================================================
# GPU Strategy 6 Block Size Comparison Script
...
RESULTS_FILE="$SCRIPT_DIR/strategy6_blocksize_comparison.md"
...
content="# GPU Strategy 6 Block Size Comparison - RTX 3050

Generated on: $timestamp

This document compares performance across different block sizes (32, 64, 128, 256, 512, 1024) for Strategy 6.

**Template Option:** Strategy 6 uses C++ templates for compile-time optimization. Each block size gets a specialized kernel version at compile-time, providing:
