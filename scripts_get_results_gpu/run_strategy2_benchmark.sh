#!/bin/bash
# ============================================================================
# GPU Strategy 2 Benchmark Script (Bash version for WSL)
...
RESULTS_FILE="$SCRIPT_DIR/strategy2_results_block${BLOCK_SIZE}.md"
...
content="# GPU Strategy 2 Benchmark Results - RTX 3050
