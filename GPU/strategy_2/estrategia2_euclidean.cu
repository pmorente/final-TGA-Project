...
// KERNEL EUCLIDEAN
// ============================================================================
__global__ void euclidean_strategy2(
...
void launch_euclidean_strategy2(
    ...
    int BLOCK_SIZE)
{
    ...
    euclidean_strategy2<<<grid, block>>>(
...
int main(int argc, char* argv[]) {
    ...
    try {
        ...
        std::cout << "\n=== Strategy 2: Grid over SMALL group, Euclidean Benchmark ===" << std::endl;
        ...
        launch_euclidean_strategy2(d_queries, d_database, d_results, num_queries, num_database, dim, block_size);
