...
// KERNEL EUCLIDEAN
// ============================================================================
__global__ void euclidean_strategy1(
...
void launch_euclidean_strategy1(
    ...
    int dim)
{
    dim3 grid(num_queries, num_database);
    dim3 block(1);
    
    euclidean_strategy1<<<grid, block>>>(
...
int main(int argc, char* argv[]) {
    ...
    try {
        ...
        std::cout << "\n=== Strategy 1: Grid over pairs, Euclidean Benchmark ===" << std::endl;
        ...
        launch_euclidean_strategy1(d_queries, d_database, d_results, num_queries, num_database, dim);
