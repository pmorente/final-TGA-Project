#!/bin/bash
# ============================================================================
# GPU Strategy 3 Benchmark Script (Bash version for WSL)
...
RESULTS_FILE="$SCRIPT_DIR/strategy3_results_block${BLOCK_SIZE}.md"
...
content="# GPU Strategy 3 Benchmark Results - RTX 3050
