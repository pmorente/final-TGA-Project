...
// Algorithm: Pearson Correlation (Sequential per thread, no reduction)
...
// KERNEL PEARSON
// ============================================================================
__global__ void pearson_strategy2(
...
int main(int argc, char* argv[]) {
    ...
    try {
        ...
        std::cout << "\n=== Strategy 2: Grid over SMALL group, Pearson Benchmark ===" << std::endl;
        ...
        launch_pearson_strategy2(d_queries, d_database, d_results, num_queries, num_database, dim, block_size);
