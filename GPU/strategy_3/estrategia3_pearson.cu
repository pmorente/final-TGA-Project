...
// KERNEL PEARSON
// ============================================================================
__global__ void pearson_strategy3(
...
int main(int argc, char* argv[]) {
    ...
    try {
        ...
        std::cout << "\n=== Strategy 3: Grid over BIG group, Pearson Benchmark ===" << std::endl;
        ...
        launch_pearson_strategy3(d_queries, d_database, d_results, num_queries, num_database, dim, block_size);
